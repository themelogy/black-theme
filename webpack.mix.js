...
mix.combine([`${dist}/css/bootstrap.css`, `${dist}/css/font-awesome.css`, `${dist}/css/styles.css`], `${dist}/css/all.css`);
...
if(!isProduction) {
    mix
    .browserSync({
        proxy: 'dev.zirvearackiralama.com',
        files: [__dirname + '/**/*.*']
    });
} else {
    mix.version();
